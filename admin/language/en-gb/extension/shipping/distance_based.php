<?php
//==============================================================================
// Distance-Based Shipping v303.1
// 
...
$_['entry_google_apikey']				= 'Google Maps API Key: <div class="help-text">Enter your Google Maps API Key here, if you have one. If you do not, leave it blank. However, if you start getting errors saying OVER_QUERY_LIMIT, you should sign up for a Google Maps API Key and fill it in. When signing up for the API Key, make sure you choose to enable "Routes".</div>';
...
$_['help_customer_data']				= 'Select a customer field to compare against, and then enter the required value. Separate multiple values using commas. Leave this field blank to check for any filled in value. For example:<br><br><b>Company is __________</b><br><br>will check to make sure the Company field is filled in.';
...
$_['text_recurring_profile']			= 'Recurring Profile';
$_['help_recurring_profile']			= 'Choose a recurring profile from the list. This will apply the charge to any products in the cart that has (or does not have) the chosen profile.';
...
//------------------------------------------------------------------------------
$_['help_heading']						= 'The heading under which these shipping options will appear. HTML is supported.<br /><br />Use the shortcode [' . strtolower(str_replace('-Based', '', $name)) . '] to display the calculated ' . strtolower(str_replace('-Based', '', $name)) . '.<br /><br />This heading is for';
$_['help_charge_title']					= 'The title displayed to the customer. HTML is supported.<br /><br />Use the shortcode [' . strtolower(str_replace('-Based', '', $name)) . '] to display the calculated ' . strtolower(str_replace('-Based', '', $name)) . '.<br /><br />This title is for';

$_['column_group']						= 'Sort Order';
$_['help_charge_group']					= 'Enter the sort order in which the charges will appear. If you enter a negative value, the charge will be disabled.';

$_['help_charge_charges']				= 'Separate charge brackets by commas or new lines, and enter them in the format:<br /><br /><b>From - To = Cost / Per</b><br /><br />The "Per" setting is optional. For example, to charge $6.00 for 0-2 miles, and $2.00 per mile beyond that, you would enter:<br /><div class="text-left" style="margin: 10px">0-2 = 6.00<br />2-9999 = 2.00 / 1</div>You can leave out the "From" and "To" values if they would be 0 and 999999, respectively.';

$_['help_adjust_comparison']			= 'Final charge adjustments occur after the charge has been calculated. For example, to increase the charge by 10% after calculations, enter 10% in the field.';
$_['help_cumulative']					= 'Cumulative bracket charges mean that each successive bracket will be added together. For example, if you charge $2.00 for 0-1 km and $3.00 for 1-2 km, then an order that is 1.5 km will charge $2.00 + $3.00 = $5.00';
?>