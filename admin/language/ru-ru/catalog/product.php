...
$_['entry_sku']              = 'Артикул';
$_['entry_upc']              = 'Кол-во товара в упаковке';
$_['entry_ean']              = 'EAN';
$_['entry_jan']              = 'Штрих-код';
$_['entry_isbn']             = 'ISBN';
$_['entry_mpn']              = 'Цена товара до скидки:';
...
$_['help_upc']               = 'Отображается на странице продукта.';
$_['help_ean']               = 'Европейский код товара';
$_['help_jan']               = 'Штрих-код товара';
$_['help_isbn']              = 'Международный стандарт номера книги';
$_['help_mpn']               = 'Перечеркнутая цена. Не забудьте установить акцию на товар и добавить цену в акции такую же, как цена в 1С';
