...
class ControllerExtensionShippingDistanceBased extends Controller {
	...
	public function index() {
		...
		$data['rule_options'] = array(
			...
			'location_criteria'			=> array('country', 'geo_zone', 'location_comparison', 'zone'),
		...
		$data['settings'][] = array(
			'type'		=> 'tabs',
			'tabs'		=> array('extension_settings', 'charges', 'testing_mode'),
		);
		$data['settings'][] = array(
