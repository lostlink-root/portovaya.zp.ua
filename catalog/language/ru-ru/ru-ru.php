...
$_['text_mins']  = "мин";
$_['text_secs']  = "сек";
$_['text_countdown']  = "<span>Поторопитесь!</span> скидка закончится через:";
...
// Text
$_['text_home']             = '<span style="background: #f4f4f4;padding: 5px 10px; border-radius: 10px;"><i class="fa fa-home"></i> Главная</span>';
$_['text_yes']              = 'Да';
$_['text_no']               = 'Нет';
