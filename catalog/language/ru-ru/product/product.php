...
$_['text_model']               = 'Модель:';
$_['text_upc']                 = 'Количество товара в упаковке:';
$_['text_reward']              = '<a href="/index.php?route=account/login">Зарегистрируйтесь или войдите</a> в аккаунт, чтобы при покупке получить';
