			...
			'payment_address' => array(
				...
				'fields' => array(
					...
					'email' => array(	 'display' => 1,
										 'require' => 0,
										 'error' => array(0 => array('min_length' => 0,
															 'max_length' => 96,
															 'text' => array(1 => 'Sorry, but you need to have the length of the text more then 0 and less then 96 ')),

												  1 => array('email_exists' => true,
															 'text' => 'error_exists')/*,
