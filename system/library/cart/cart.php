...
class Cart {
	...
	public function getProducts() {
		$product_data = array();
		$cart_query = $this->db->query("SELECT " . DB_PREFIX . "cart.*, 
		    " . DB_PREFIX . "product.quantity AS product_quantity, " . DB_PREFIX . "product.sku, 
		    IF((SELECT COUNT(*) 
		            FROM " . DB_PREFIX . "product_to_category 
                    WHERE " . DB_PREFIX . "product_to_category.product_id = " . DB_PREFIX . "cart.product_id 
                        AND " . DB_PREFIX . "product_to_category.category_id = 368) > 0, 1, 0) as is_adult
		    FROM " . DB_PREFIX . "cart 
		    LEFT JOIN " . DB_PREFIX . "product ON " . DB_PREFIX . "cart.product_id = " . DB_PREFIX . "product.product_id  
